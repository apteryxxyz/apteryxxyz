...
In developing browser extensions, I utilise Plasmo, a framework for creating extensions using React. This framework has helped me create the [companion extension](https://go.evaluate.run/m6mobFR) for my Evaluate app.
